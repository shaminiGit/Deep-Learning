...
train_directory = '/home/ubuntu/aclImdb/train/'
...
test_directory = '/home/ubuntu/aclImdb/test/'
...
## save dictionary
np.save('/home/ubuntu/preprocessed_data/imdb_dictionary.npy',np.asarray(id_to_word))
...
glove_filename = '/home/ubuntu/glove.840B.300d.txt'
...
np.save('/home/ubuntu/preprocessed_data/glove_dictionary.npy',glove_dictionary)
np.save('/home/ubuntu/preprocessed_data/glove_embeddings.npy',glove_embeddings)
